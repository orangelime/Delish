    ...
    <div class="navigation" >
        ...
        <nav class="navigation__nav">
            <ul class="navigation__list">
                ...
                <li class="navigation__item"><a href="#benefits" class="navigation__link"  @click="selectNavItem"><span>04</span>Your benefits</a></li>
                <li class="navigation__item"><a href="#menus" class="navigation__link"  @click="selectNavItem"><span>05</span>Popular menus</a></li>
                <li class="navigation__item"><a href="#stories" class="navigation__link"  @click="selectNavItem"><span>06</span>Stories</a></li>
                <li class="navigation__item"><a href="#joinus" class="navigation__link"  @click="selectNavItem"><span>07</span>Join us</a></li>
